...
try {
  ...
  function export($collection, Connection $connection, $fastq_col) {
    ...
    $settings = array(
      ...
      'restrict' => array(
        'type' => 'include',
        'fields' => array('FILE_NAME','FASTQ_COL')
      )
    );
  ...
  // run the export
  export('FASTQ_LIST', $connection, $argv[1]);
